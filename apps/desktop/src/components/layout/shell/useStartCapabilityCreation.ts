...
const CAPABILITY_CREATION_PROMPT =
  "/capability-creator Let's build a combo together. Ask me what outcome it should deliver and which apps it touches, then assemble the skills and connections.";
